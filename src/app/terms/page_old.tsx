...
import { FileText, Users, Shield, CreditCard, AlertTriangle, Scale, Phone, Globe } from 'lucide-react';
        ...
        <div className='mx-auto max-w-7xl px-6 lg:px-8'>
          <div className='mx-auto max-w-4xl text-center'>
            <div className='mb-6 flex items-center justify-center'>
              <Badge variant='secondary' className='mb-4 flex items-center gap-2 px-4 py-2'>
              ...
              <div className='sticky top-8'>
                <Card className='border-green-200 bg-green-50/50'>
                  <CardHeader className='pb-4'>
                    <CardTitle className='text-lg text-green-900'>Table of Contents</CardTitle>
                  </CardHeader>
                  <CardContent>
