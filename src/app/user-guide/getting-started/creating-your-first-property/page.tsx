              ...
              <div className='rounded-lg border bg-white shadow-sm'>
                ...
                <div className='border-b p-6'>
                  ...
                  <p className='text-lg text-gray-600'>
                    Learn how to add your first property to Syndik and get
                    started with property management. This guide will walk you
                    through the complete process of creating a property and
                ...
                <div className='space-y-8 p-6'>
                  ...
                  <section id='overview'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      Creating your first property is an important step in
                      setting up your property management system. This guide
                      will walk you through the entire process, from navigation
                      to configuration, ensuring you have all the necessary
                        ...
                        <div className='flex items-start space-x-3'>
                          ...
                          <div>
                            ...
                            <ul className='mt-2 space-y-1 text-sm text-blue-700'>
                              ...
                              <li>
                                • How to configure initial property settings
                              </li>
                            </ul>
                          </div>
                        </div>
                    ...
                    <div className='space-y-4'>
                      <div className='flex items-start space-x-3'>
                        ...
                        <div>
                          ...
                          <p className='text-sm text-gray-600'>
                            Click on <strong>&quot;Buildings&quot;</strong> in
                      ...
                      <div className='flex items-start space-x-3'>
                        ...
                        <div>
                          ...
                          <p className='text-sm text-gray-600'>
                            Look for the{' '}
                            <strong>&quot;Add New Property&quot;</strong> button
                        ...
                        <div className='flex items-start space-x-3'>
                          ...
                          <div>
                            ...
                            <p className='text-sm text-yellow-700'>
                              Make sure you have all property documents ready
                              before starting, including property deeds,
                              building permits, and any existing tenant
                              information.
                            </p>
                          </div>
                        </div>
                  ...
                  <section id='step-2'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      The property creation form requires the following
                      information. Make sure to fill in all required fields
                      accurately:
                    </p>
                  ...
                  <section id='step-3'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      After entering the basic details, configure these
                      important settings to ensure smooth operations:
                    </p>
                    ...
                    <div className='space-y-4'>
                      <Card>
                        ...
                        <CardContent>
                          <p className='text-sm text-gray-600'>
                            ...
                            methods, and due dates that will apply to all units
                            in this property.
                          </p>
                        </CardContent>
                      </Card>
                      ...
                      <Card>
                        ...
                        <CardContent>
                          <p className='text-sm text-gray-600'>
                            Choose how residents can contact management and
                      ...
                      <Card>
                        ...
                        <CardContent>
                          <p className='text-sm text-gray-600'>
                            Configure maintenance request workflows, assign
                            default maintenance staff, and set priority levels.
                          </p>
                        </CardContent>
                      </Card>
                    </div>
                  ...
                  <section id='next-steps'>
                    ...
                    <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
                      <Link href='/user-guide/property-management/adding-units'>
                        <Card className='cursor-pointer transition-shadow hover:shadow-md'>
                          <CardContent className='p-4'>
                            <h4 className='mb-2 font-semibold'>Add Units</h4>
                            <p className='text-sm text-gray-600'>
                              Learn how to add individual units to your
                              property.
                            </p>
                          </CardContent>
                        </Card>
                      ...
                      <Link href='/user-guide/resident-management/adding-residents'>
                        <Card className='cursor-pointer transition-shadow hover:shadow-md'>
                          <CardContent className='p-4'>
