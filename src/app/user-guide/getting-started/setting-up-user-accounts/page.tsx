              ...
              <div className='rounded-lg border bg-white shadow-sm'>
                ...
                <div className='border-b p-6'>
                  ...
                  <p className='text-lg text-gray-600'>
                    Learn how to create and manage user accounts in Syndik, set
                    up proper permissions, and invite team members to your
                ...
                <div className='space-y-8 p-6'>
                  ...
                  <section id='overview'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      Setting up user accounts properly is crucial for
                      maintaining security and ensuring smooth operations in
                      your property management system. This guide will walk you
                      through creating different types of accounts and managing
                      user access.
                    </p>
                        ...
                        <div className='flex items-start space-x-3'>
                          ...
                          <div>
                            ...
                            <p className='mt-1 text-sm text-blue-700'>
                              Make sure you have administrative privileges and
                              have completed the initial property setup.
                            </p>
                          </div>
                        </div>
                      </CardContent>
                  ...
                  <section id='creating-admin'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      Admin accounts have full access to all features and
                      settings. Follow these steps to create admin accounts:
                    </p>
                    ...
                    <div className='space-y-4'>
                      <div className='flex items-start space-x-3'>
                        ...
                        <div>
                          ...
                          <p className='text-sm text-gray-600'>
                            Go to Settings → Users & Permissions → User
                            Management
                          </p>
                        </div>
                      </div>
                      ...
                      <div className='flex items-start space-x-3'>
                        ...
                        <div>
                          ...
                          <p className='text-sm text-gray-600'>
                            Click &quot;Send Invitation&quot; to email the new
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <div className='space-y-3'>
                          <p className='text-sm text-gray-600'>
                            Use the &quot;Bulk Invite&quot; feature to add
                  ...
                  <section id='setting-permissions'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      You can customize permissions for each role or create
                      custom permission sets:
                    </p>
                    <ul className='list-inside list-disc space-y-1 text-gray-700'>
                      <li>
                        Property-specific access (limit users to certain
                        properties)
                      </li>
                      <li>
                        Feature-based permissions (financial data, reports,
                        etc.)
                      </li>
