              ...
              <div className='rounded-lg border bg-white shadow-sm'>
                ...
                <div className='border-b p-6'>
                  ...
                  <p className='text-lg text-gray-600'>
                    Learn how to add new properties to your Syndik portfolio
                    with proper configuration, unit setup, and document
                    management for efficient property operations.
                  </p>
                </div>
                ...
                <div className='space-y-8 p-6'>
                  ...
                  <section id='overview'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      Adding a new property to Syndik involves several key steps
                      to ensure all information is properly configured and your
                        ...
                        <div className='flex items-start space-x-3'>
                          ...
                          <div>
                            ...
                            <p className='mt-1 text-sm text-blue-700'>
                              Gather all property information and legal
                              documents before starting the setup process to
                  ...
                  <section id='preparation'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      Prepare the following information and documents before
                    ...
                    <div className='space-y-4'>
                      ...
                      <div className='flex items-start space-x-3'>
                        ...
                        <div>
                          ...
                          <p className='text-sm text-gray-600'>
                            Choose a clear, descriptive name that helps identify
                            the property
                          </p>
                        </div>
                      </div>
                      ...
                      <div className='flex items-start space-x-3'>
                        ...
                        <div>
                          ...
                          <p className='text-sm text-gray-600'>
                            Enter full street address, city, state, and ZIP code
                      ...
                      <div className='flex items-start space-x-3'>
                        ...
                        <div>
                          ...
                          <p className='text-sm text-gray-600'>
                            Choose from apartment complex, single-family,
                            townhome, or commercial
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <Card className='mt-6'>
                      ...
                      <CardContent>
                        <p className='mb-3 text-sm text-gray-700'>
                          Syndik will automatically verify and geocode your
                          property address for mapping and location services.
                        </p>
                        <div className='rounded-lg bg-gray-50 p-3'>
                          <p className='text-xs text-gray-600'>
                            <strong>Tip:</strong> If the address isn&apos;t
                            found, double-check the spelling and format. You can
                            also use GPS coordinates for rural properties.
                          </p>
                        </div>
                      </CardContent>
                    </Card>
                        ...
                        <div className='flex items-start space-x-3'>
                          ...
                          <div>
                            ...
                            <ul className='mt-2 space-y-1 text-sm text-amber-700'>
                              <li>
                                • Use consistent numbering format (e.g., 101,
                                102, 201, 202)
                              </li>
                              <li>
                              ...
                              <li>
                                • Avoid special characters that might cause
                                system issues
                              </li>
                              <li>
                                • Consider future expansion in your numbering
                                scheme
                              </li>
                            </ul>
                          </div>
                  ...
                  <section id='verification'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      Before finalizing your property setup, review all
                    ...
                    <div className='mt-6 rounded-lg border border-blue-200 bg-blue-50 p-4'>
                      <p className='text-sm text-blue-800'>
                        <strong>Next Steps:</strong> Once your property is
                        added, you can begin adding residents, setting up
                        maintenance schedules, and configuring financial
                        tracking. Consider scheduling a property walkthrough to
