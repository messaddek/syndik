              ...
              <div className='rounded-lg border bg-white shadow-sm'>
                ...
                <div className='border-b p-6'>
                  ...
                  <p className='text-lg text-gray-600'>
                    ...
                    payments, reduce late fees, and improve cash flow management
                    for your properties.
                  </p>
                </div>
                ...
                <div className='space-y-8 p-6'>
                  ...
                  <section id='overview'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      Automated rent collection is one of the most valuable
                      features in Syndik, allowing you to reduce administrative
                      work while ensuring consistent, timely rent payments from
                      residents.
                    </p>
                  ...
                  <section id='payment-methods'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      Configure multiple payment options to accommodate
                        ...
                        <CardContent>
                          ...
                          <div className='mt-4 rounded-lg bg-blue-50 p-3'>
                            <p className='text-xs text-blue-700'>
                              <strong>Note:</strong> ACH transfers have the
                              lowest fees and are preferred for recurring
                              payments.
                            </p>
                          </div>
                        </CardContent>
                        ...
                        <CardContent>
                          ...
                          <div className='mt-4 rounded-lg bg-amber-50 p-3'>
                            <p className='text-xs text-amber-700'>
                              <strong>Warning:</strong> Traditional methods
                              require manual processing and increase
                              administrative work.
                            </p>
                          </div>
                        </CardContent>
                  ...
                  <section id='rent-schedules'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      Configure when and how often rent is collected from
                      residents:
                    </p>
                  ...
                  <section id='automatic-collection'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      Set up autopay to automatically collect rent from
                      residents who opt in:
                    </p>
                  ...
                  <section id='late-fees'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      Configure late fees and penalty structures to encourage
                      timely payments:
                    </p>
                            ...
                            <div className='flex items-start space-x-3'>
                              ...
                              <div>
                                ...
                                <p className='mt-1 text-sm text-amber-700'>
                                  ...
                                  regulations. Some jurisdictions limit the
                                  maximum late fee amount or require specific
                                  notice periods.
                                </p>
                              </div>
                            </div>
                  ...
                  <section id='notifications'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      Configure automated notifications to keep residents
                      informed about payments:
                    </p>
                          ...
                          <div className='space-y-4'>
                            <div>
                              ...
                              <p className='mt-1 text-sm text-gray-600'>
                                ...
                                collection dates accordingly and inform
                                residents about processing times.
                              </p>
                            </div>
                            <div>
                              <h4 className='font-medium text-gray-900'>
                              ...
                              <p className='mt-1 text-sm text-gray-600'>
                                Automatically retry failed payments after 2-3
                                days. Send notifications to residents about
                                payment failures and request updated payment
                                information.
                              </p>
                            </div>
                            <div>
                              ...
                              <p className='mt-1 text-sm text-gray-600'>
                                Configure whether to accept partial payments and
                                how to handle remaining balances. Set up
                                automatic payment plans if needed.
                              </p>
                            </div>
                          </div>
                        </CardContent>
