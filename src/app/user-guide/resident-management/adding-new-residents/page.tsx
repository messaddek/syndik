              ...
              <div className='rounded-lg border bg-white shadow-sm'>
                ...
                <div className='border-b p-6'>
                  ...
                  <p className='text-lg text-gray-600'>
                    Complete guide to onboarding new residents, from initial
                    setup to move-in completion. Learn the step-by-step process
                    for adding residents to your property management system.
                  </p>
                </div>
                ...
                <div className='space-y-8 p-6'>
                  ...
                  <section id='overview'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      ...
                      foundation for a successful landlord-tenant relationship.
                      This guide covers everything from initial documentation to
                  ...
                  <section id='preparation'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      Before adding a resident to the system, ensure you have
                  ...
                  <section id='resident-profile'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      Follow these steps to create a comprehensive resident
                      profile in Syndik:
                    </p>
                    ...
                    <div className='space-y-4'>
                      ...
                      <div className='flex items-start space-x-3'>
                        ...
                        <div>
                          ...
                          <p className='text-sm text-gray-600'>
                            Include at least one emergency contact with
                      ...
                      <div className='flex items-start space-x-3'>
                        ...
                        <div>
                          ...
                          <p className='text-sm text-gray-600'>
                            Attach ID copies, lease documents, and other
                            required files
                          </p>
                        </div>
                      </div>
                  ...
                  <section id='payment-setup'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      Configure payment methods and collection preferences for
                      the new resident.
                    </p>
                  ...
                  <section id='access-credentials'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      Set up system access and physical access for the new
                      resident.
                    </p>
                  ...
                  <section id='move-in-checklist'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      Complete these final steps to finalize the resident
                      onboarding process.
                    </p>
                  ...
                  <section id='communication-setup'>
                    ...
                    <p className='mb-4 text-gray-700'>
                      Configure communication preferences and introduce the
                      resident to available channels.
                    </p>
                        ...
                        <div className='flex items-start space-x-3'>
                          ...
                          <div>
                            ...
                            <p className='text-sm text-green-700'>
                              You&apos;ve successfully added a new resident to
                              your property. The resident should now have access
                              to their portal and can begin using Syndik&apos;s
                              resident services.
                            </p>
                          </div>
                        </div>
